...
public class AccountIterator implements Iterator {
    ...
    }//This obtains an already existing ArrayList for use within this calss
    ...
    @Override
    //This function checks when the position is at 0, and prevnts the user from going back even further.
    public boolean hasPrev(int positin){
        if(position == 0)
        return false;
        else    
            return true;
